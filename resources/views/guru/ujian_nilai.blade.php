...
<div class="row">
    <div class="col-md-12 mb-4">
        <div class="card shadow-sm border-0 border-start border-4 border-info rounded-4">
            <div class="card-body d-flex justify-content-between align-items-center flex-wrap gap-2">
                <div>
                    <h4 class="mb-1 fw-bold text-info text-break"><i class="fas fa-clipboard-check me-2"></i>Daftar Nilai: {{ $ujian->judul_ujian }}</h4>
    ...
    <div class="col-md-12">
        <div class="card shadow-sm border-0 border-top border-4 border-info rounded-4 overflow-hidden">
            <div class="card-header bg-white fw-bold text-dark py-3">
                <i class="fas fa-users me-1 text-info"></i> Daftar Siswa & Status Ujian
            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    @if($hasil)
                                        <span class="badge bg-success shadow-sm px-3 py-2 rounded-pill"><i class="fas fa-check-circle me-1"></i> Selesai</span>
                                    @else
                                        <span class="badge bg-secondary shadow-sm px-3 py-2 rounded-pill opacity-75"><i class="fas fa-clock me-1"></i> Belum/Tidak Mengerjakan</span>
                                    @endif
                                </td>
                                ...
                                <td class="text-center">
                                    @if($hasil)
                                        <a href="{{ route('guru.ujian.koreksi', ['ujian_id' => $ujian->id, 'siswa_id' => $siswa->id]) }}" class="btn btn-sm btn-info text-white fw-bold shadow-sm rounded-pill px-3 transition-all">
